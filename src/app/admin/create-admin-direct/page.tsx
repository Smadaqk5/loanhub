...
BEGIN
  ...
  INSERT INTO public.users (
    ...
    admin_user_id, '${adminData.fullName}', '${adminData.nationalId}',
    '${adminData.phone}', '${adminData.email}', '${adminData.kraPin}',
    crypt('${adminData.password}', gen_salt('bf')), 'admin', 'active', NOW(), NOW()
  );
END $$;
      `
